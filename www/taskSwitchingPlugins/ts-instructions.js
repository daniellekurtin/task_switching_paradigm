...
var trial = {
    ...
    pages: [
        ...
        'All tasks have a similar format- a grid 6 boxes long and 6 boxes wide will appear.: <img src="blank_stimgrid.png"></img>',
        ...
        'During one task, The "Digit Span", six numbers will flash on the grid, one after the other.: <img src="DS_cuecard.png"></img>', 
        
        'Your job is to remember the six numbers in order, and select the answer grid that has the 6 numbers from left to right. The other two answer grids will show the same numbers, except for one.: <img src="DS_answr_exmpl.png"></img>',

        'During the "Spatial Span" the grid will highlight 6 boxes, one after another. Your job is to remember which spaces have been occupied by boxes, and select the answer grid that shows all the boxes that were highlighted. The other two grids will show the same pattern, except for one.: <img src="SS_cuecard.png"></img>',

        'The "Spatial Rotation" is our last task.: <img src="SR_cuecard.png"></img>', 
        
        'During the "Spatial Rotation" boxes will become highlighted, though instead of disappearing, they add one after another. The grid will then be rotated 90, 180, or 270 degrees.: <img src="SR_stim_exmpl.png"></img>', 
        
        'Your job is to pick the answer grid that has the same pattern. The other two grids will show the same pattern as the answer grid, except for one box.: <img src="SR_answr_exmpl.png"></img>',
